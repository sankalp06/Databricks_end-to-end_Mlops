...
#df = spark.read.format("csv").option("header", "true").load("/mnt/inference_layer/batch_1.csv")
df = spark.read.format("csv").option("header", "true").load("/mnt/inference_layer/batch_1.csv")
...
# MAGIC %pip install mlflow==1.16.0 scipy==1.6.3 seaborn==0.11.1
...
project_home_dir = f"/Users/{username}/dais_2021/"
...
workspace_project_home = f"/Users/{username}/DAIS_2021"
